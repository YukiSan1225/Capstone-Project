    ...
    <section id="infoBox">
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            while($row = mysqli_fetch_assoc($result)){
                echo "<tr><td>".$row["website_name"]."</td><td>".$row["email_username"]."</td><td>".$row["password"]."</td><td><button onclick=\"deleteRow()\"><a href=delete.php?id=".$row["tnum"].">Delete</button></td></tr>";
            }
            echo "</table>";
        }
        else{
